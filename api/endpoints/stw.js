...
var authRequest2 = {//request variable
  'method': 'GET',//you need to send a post request for a auth code
  'url': 'https://fortnite-public-service-prod11.ol.epicgames.com/fortnite/api/game/v2/world/info',//just the url
  'headers': {
...
fs.writeFile('./logs/stw.json', response2.body, 'utf8', (err) => {
